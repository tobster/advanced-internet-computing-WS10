...
public class WarehouseServiceTest extends BaseIntegrationTest{
    ...
    public void orderTest() {
        try {
            ...
            Logger.getLogger(WarehouseServiceTest.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public void check_availabilityTests() {
        try {
            ...
            try {
                ...
                assertThat(e.getMessage(), is("negative amount fault"));
            }
        } catch (UnknownProductFault ex) {
            Logger.getLogger(WarehouseServiceTest.class.getName()).log(Level.SEVERE, null, ex);
        } catch (NegativeAmountFault ex) {
            Logger.getLogger(WarehouseServiceTest.class.getName()).log(Level.SEVERE, null, ex);
        }
